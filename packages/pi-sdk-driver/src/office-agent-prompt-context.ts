...
export function getOfficeAgentAppPromptContext(options: OfficeAgentAppPromptContextOptions): string {
  return [
    ...
    "El usuario te podrá pedir explorar otros archivos, pero a la hora de hacer cualquier tipo de modificaciones en un archivo que no está presente en tu proyecto, haz primero una copia dentro de la carpeta de tu proyecto, y haz las modificaciones en ese achivo.",
    ...
    "Cuando el usuario diga 'mi Escritorio', 'mis Descargas', 'mis Documentos', 'mis Imágenes', 'mis Vídeos' o algo similar, usa las variables OFFICE_AGENT_REAL_DESKTOP, OFFICE_AGENT_REAL_DOWNLOADS, OFFICE_AGENT_REAL_DOCUMENTS, OFFICE_AGENT_REAL_PICTURES y OFFICE_AGENT_REAL_VIDEOS en vez de USERPROFILE/HOME.",
    "Ejemplos en PowerShell: $env:OFFICE_AGENT_REAL_DESKTOP para el Escritorio real; $env:OFFICE_AGENT_ACTIVE_PROJECT para el proyecto activo donde debes guardar resultados; $env:OFFICE_AGENT_SANDBOX_PROFILE para el perfil privado del sandbox.",
    "Puedes intentar leer carpetas reales del usuario mediante OFFICE_AGENT_REAL_*, pero las escrituras fuera del proyecto/raíz gestionada de OfficeAgent estarán bloqueadas; guarda resultados nuevos dentro del proyecto activo salvo instrucción explícita y viable del usuario.",
