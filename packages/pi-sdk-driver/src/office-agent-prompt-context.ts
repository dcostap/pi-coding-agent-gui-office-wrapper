...
export function getOfficeAgentManagedWorkspacePromptContext(
  ...
  return [
    ...
    "Cuando el usuario diga 'mi Escritorio', 'mis Descargas', 'mis Documentos', 'mis Imágenes', 'mis Vídeos', 'mi Música', 'mi carpeta temporal', 'Temp' o algo similar, usa las variables OFFICE_AGENT_REAL_USER_DESKTOP, OFFICE_AGENT_REAL_USER_DOWNLOADS, OFFICE_AGENT_REAL_USER_DOCUMENTS, OFFICE_AGENT_REAL_USER_PICTURES, OFFICE_AGENT_REAL_USER_VIDEOS, OFFICE_AGENT_REAL_USER_MUSIC y OFFICE_AGENT_REAL_USER_TEMP en vez de USERPROFILE/HOME.",
    "Ejemplos en comandos: %OFFICE_AGENT_REAL_USER_DESKTOP% para el Escritorio real; %OFFICE_AGENT_REAL_USER_TEMP% para la carpeta temporal real del usuario; %OFFICE_AGENT_WORKSPACE% para el proyecto activo donde debes guardar resultados; %OFFICE_AGENT_TOOL_FILES% para archivos entregables/materializados por herramientas; %OFFICE_AGENT_SCRATCH% para scripts/intermedios ocultos; %OFFICE_AGENT_SANDBOX_PROFILE% para el perfil privado del sandbox.",
    "Usa %OFFICE_AGENT_SCRATCH% para scripts temporales, análisis intermedios y archivos auxiliares que no deban aparecer como resultado para el usuario; usa %OFFICE_AGENT_WORKSPACE% para entradas copiadas y salidas finales visibles. Los resultados grandes o archivos creados/materializados por herramientas remotas se guardan bajo %OFFICE_AGENT_TOOL_FILES% dentro del proyecto activo.",
