...
export function getOfficeAgentAppPromptContext(options: OfficeAgentAppPromptContextOptions): string {
  return [
    ...
    "Ejemplos en comandos: %OFFICE_AGENT_REAL_USER_DESKTOP% para el Escritorio real; %OFFICE_AGENT_WORKSPACE% para el proyecto activo donde debes guardar resultados; %OFFICE_AGENT_SANDBOX_PROFILE% para el perfil privado del sandbox.",
