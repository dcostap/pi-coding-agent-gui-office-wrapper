...
export function getOfficeAgentManagedWorkspacePromptContext(
  ...
  return [
    ...
    "Ejemplos en comandos: %OFFICE_AGENT_REAL_USER_DESKTOP% para el Escritorio real; %OFFICE_AGENT_REAL_USER_TEMP% para la carpeta temporal real del usuario; %OFFICE_AGENT_WORKSPACE% para el proyecto activo donde debes guardar resultados; %OFFICE_AGENT_SCRATCH% para scripts/intermedios ocultos; %OFFICE_AGENT_SANDBOX_PROFILE% para el perfil privado del sandbox.",
